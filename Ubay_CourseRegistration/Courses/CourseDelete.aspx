<%@ Page Title="" Language="C#" MasterPageFile="~/Managers/ManagerMaster.Master" AutoEventWireup="true" CodeBehind="CourseDelete.aspx.cs" Inherits="Ubay_CourseRegistration.Courses.CourseDelete" %>
                        ...
                        <asp:Repeater ID="rptResult" runat="server" OnItemCommand="rptResult_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><asp:Button runat="server" ID="btnDelete" Text="Del" CommandName="DeleteItem"
